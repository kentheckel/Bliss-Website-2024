...
for(const file of ['index.html','access/index.html','admin/index.html','agency/index.html','analytics/cam-view-history.js','deck/index.html']) if(!existsSync(`public/${file}`)) throw new Error(`Missing release file: ${file}`);
