...
const directories = ['Documents','Spurs','Videos','YouTube','agency','analytics','aspensnowmass','audio','clubamerica','data','facebook','games','gmail','images','js','lewishamilton','logos','lukadoncic','lukaslovenia','parisvsslovenia','pitch','access','admin','services'];
